...
categories: courses self-study C tutorial book
---
...
2. [Basics](#chapter-2-basics)
    1. [Your computer can memorize things](#section-1-memorization)
    2. [Your computer can "talk" and "listen"](#section-2-talk-and-listen)
    3. [Compiling and Running programs](#section-3-compiling-and-running)
3. [Functions](#chapter-3-functions)
    1. [I receive Inputs, You receive Output](#section-1-input-output)
    2. [Simple pattern matching](#section-2-pattern-matching)
    3. [Function calling and Recursion](#section-3-recursion)
4. [Control Flow](#chapter-4-control-flow)
    1. [Branching on a condition](#section-1-branching)
    2. [Branching back is called Looping](#section-2-looping)
5. [Pointers](#chapter-5-pointer)
    1. [How to think about a computer's memory](#section-1-computer-memory)
    2. [Memory address of my variable](#section-2-variable-address)
    3. [Pointer arithmetic](#section-3-pointer-arithmetic)
6. [Arrays](#chapter-6-array)
    1. [Hold my integers](#section-1-int-array)
    2. [Memory address of my variable](#section-2-variable-address)
    3. [The size of my array](#section-3-array-size)
7. [Data Structure](#chapter-7-struct)
    1. [All variables in one place](#section-1-data-bundle)
    2. [Example: Stack](#section-2-example-stack)
    2. [Example: Naive Queue](#section-3-example-queue)

# Hello, World! <a name="chapter-1-hello-world" />
...
# Basics <a name="chapter-2-basic" />

## Your computer can memorize things <a name="section-1-memorization" />
...
## Your computer can \"talk\" and \"listen\" <a name="section-2-talk-and-listen" />
...
## Compiling and Running programs <a name="section-3-compiling-and-running" />
...
## I receive Inputs, You receive Output <a name="section-1-input-output" />
...
## Simple pattern matching <a name="section-2-pattern-matching" />
...
## Function calling and Recursion <a name="section-3-recursion" />
...
# Control Flow <a name="chapter-4-control-flow" />
...
## Branching on a condition <a name="section-1-branching" />
...
## Branching back is called Looping <a name="section-2-looping" />
...
# Pointers <a name="chapter-5-pointer" />

## How to think about a computer's memory <a name="section-1-computer-memory" />
...
## Memory address of my variable <a name="section-2-variable-address" />
...
## Pointer arithmetic <a name="section-3-pointer-arithmetic" />
...
# Arrays <a name="chapter-6-array" />

## Hold my integers <a name="section-1-int-array" />
...
$4 \cdot 3 \cdot 6 \cdot 2 \cdot 5 = 720$ floating-point numbers). However, there is a catch: an
...
## The size of my array <a name="section-3-array-size" />
...
# Data Structure <a name="chapter-7-struct" />

## All variables in one place <a name="section-1-data-bundle" />
...
## Example: Stack <a name="section-2-example-stack" />
...
## Example: Naive Queue <a name="section-3-example-queue" />
...
[^1]: Binary (executable) files contain only 0s and 1s, but these 0s and 1s are not typed explicitly by programmers; it's the compiler's job to translate a human-readable C code into a machine-readable binary executable file.

[^2]: mov stands for "move" instruction to tell computer move data from one place to another.
