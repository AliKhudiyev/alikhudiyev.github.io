...
or non-scientific) output* shouldn't have led to getting more
credibility in the first place. Instead, maybe ***producing** a good
output* should lead to more credibility. Or, even further than that:
maybe *it should be your effort that purely defines your credibility*.

What if it was the amount of effort that mattered, not whether the
output was or was not desirable in terms of the goals and milestones set
initially? *Genuinely high-effort works cannot be of low quality.* Not
...
To conclude, maybe we need a new systematic way of measuring the effort
...
AI-prone when it comes to cheating.
