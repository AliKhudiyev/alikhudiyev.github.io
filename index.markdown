...
<section style="margin-bottom: 2em;">
    ...
    <ul>
        ...
        <li><a href="https://www.youtube.com/@Ox416c69">Gaming</a> in my spare time.</li>
    </ul>
</section>
...
<section style="margin-bottom: 2em;">
    ...
    <ul>
    <li><a href="/projects#sorriuss-acls-cuai">SORRIUSS - A Formal and Practical Framework for Computationally Unbounded AI</a></li>
    <li><a href="/projects#online-regret-minimization-fst">Online Regret Minimization in Modelling a Finite-State Transducer over an Infinite Input-Output Stream through Scalable Aggregation of Small Stateful Predictors</a></li>
    <li><a href="/projects#mulang">MuLang: Inventing A New Mutually Understandble Language for The Natives Speaking Different Languages</a></li>
    <li><a href="/projects#comparative-study-calnet-image-datasets">Comparative Study of CALNets on Image Datasets</a></li>
    </ul>
</section>
...
<section style="margin-bottom: 2em; text-align: center;">
    ...
    <img src="assets/buy-me-a-coffee.png" width="25%" />
    <h2><a target="_blank" href="https://buymeacoffee.com/alikhudiyev">Buy me a coffee</a></h2>
</section>
